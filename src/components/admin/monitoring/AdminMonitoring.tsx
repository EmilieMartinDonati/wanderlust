...
import { getIsMonitoringModalOpen } from "../../../reducers/administration";
import { getSelectedProperty } from "../../../reducers/administration";
...
const AdminMonitoring = () => {
	...
	const isModalOpen = useAppSelector(getIsMonitoringModalOpen);
